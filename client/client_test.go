...
func (cs *clientSuite) TestStartServiceWorks(c *C) {
	...
	cli.emblemcounterEndp = endp
	cli.hapticEndp = endp
	cli.systemImageEndp = endp
	cli.pushServiceEndpoint = endp
	cli.postalServiceEndpoint = endp
...
func (cs *clientSuite) TestTakeTheBusWorks(c *C) {
	...
	cli.pushServiceEndpoint = testibus.NewTestingEndpoint(condition.Work(true), condition.Work(true))
	cli.postalServiceEndpoint = testibus.NewTestingEndpoint(condition.Work(true), condition.Work(true))
