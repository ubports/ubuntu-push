...
// Test that Call() fails but does not explode when asked to return
// values that can't be packed into a dbus message.
...
// Test that Call() fails but does not explode when given argument
